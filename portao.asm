...
menugateOpening1 db "*  1 - Final de curso aberto             *", LF, "*  2 - Fechar o portão       *", LF, "*  0 - Sair                  *", LF, "*                            *", LF, "******************************",LF, LF
lenmenugateOpening1 equ $-menugateOpening1

menugateClosing1 db "*  1 - EMERGÊNCIA            *", LF, "*  2 - Final de curso fechado             *", LF, "*  0 - Sair                  *", LF, "*                            *", LF, "******************************",LF, LF
